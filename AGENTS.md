...
- Provider scans are independent. A missing or broken Codex, Cursor, or OpenCode installation must never block the other providers. Show a provider when its CLI or local/ChatAnchor-known history exists; keep provider availability transient and out of the registry schema.
